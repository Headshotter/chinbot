...
def addpoint_command(phenny, input):
    ...
    scores.editpoints(phenny, input, nick, True)
...
def rmpoint_command(phenny, input):
    ...
    if nick:
        nick = nick.strip().split()[0]
    scores.editpoints(phenny, input, nick, False)
...
def view_scores(phenny, input):
    ...
    scores.view_scores(phenny, input)
...
def setpoint(phenny, input):
    ...
    scores.setpoint(phenny, input, line)
...
def removeuser(phenny, input):
    ...
    if line:
        line = line.lstrip().rstrip()
    scores.rmuser(phenny, input, line)
